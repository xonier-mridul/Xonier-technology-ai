  ...
  return (
    <>
      <div className='max-w-7xl mx-auto  pt-8 pb-20'>
        ...
        <div className='flex flex-col gap-4'  data-aos="fade-up" data-aos-duration="800" data-aos-delay="200">
            <div className='relative w-full pb-4'>
        ...
        <div className='flex justify-center items-center pt-14'>
            <div className='border-[1px] rounded-full border-[#dee2e6] p-2 px-5'>
