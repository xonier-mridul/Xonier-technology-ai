    ...
    <div className='  '>
      <div className='max-w-7xl mx-auto py-20 flex gap-10 items-center'>
        <div className='w-[38%] flex flex-col gap-4'>
            ...
            <h2 className='text-4xl font-bold text-cyan-900 pb-5' data-aos="fade-up" data-aos-delay="200" data-aos-duration="1000">Write Us Any Message</h2>
            <p className='text-gray-600 pb-3' data-aos="fade-up" data-aos-delay="400" data-aos-duration="1000">These are the phrases we stay via way of means of in the whole lot we do. Each brand we build, and we create.</p>
            <div className="flex items-center gap-3">
                <span data-aos="zoom-out-up" data-aos-duration="1000" data-aos-delay="100"><Link href={'https://www.linkedin.com/company/xoniertechinc/'} target='_blank' className='bg-cyan-900 h-10 w-10 flex items-center justify-center text-white hover:bg-red-500 transition-all duration-300 hover:translate-y-[-10px]'><FaLinkedinIn className='text-xl ' /></Link></span>
               <span  data-aos="zoom-out-up" data-aos-duration="1000" data-aos-delay="300"> <Link href={'https://www.facebook.com/xoniertechInc/'} target='_blank' className='bg-cyan-900 h-10 w-10 flex items-center justify-center text-white hover:bg-red-500 transition-all duration-300 hover:translate-y-[-10px]'><FaFacebookF className='text-xl ' /></Link> </span>
                <span  data-aos="zoom-out-up" data-aos-duration="1000" data-aos-delay="600"><Link href={'https://www.instagram.com/xoniertechinc/'} target='_blank' className='bg-cyan-900 h-10 w-10 flex items-center justify-center text-white hover:bg-red-500 transition-all duration-300 hover:translate-y-[-10px]'><FaInstagram className='text-xl ' /></Link></span>
                <span  data-aos="zoom-out-up" data-aos-duration="1000" data-aos-delay="900"><Link href={'https://x.com/i/flow/login?redirect_after_login=%2Fxonier_tech'} className='bg-cyan-900 h-10 w-10 flex items-center justify-center text-white hover:bg-red-500 transition-all duration-300 hover:translate-y-[-10px]'><FaXTwitter className='text-xl ' /></Link></span>
            </div>
        </div>
        <div className='w-[62%]'>
            <form onSubmit={(e)=>handleSubmit(e)}>
                <div className='grid grid-cols-2 gap-5'>
                    <div className='flex flex-col gap-3 ' data-aos="zoom-out-up" data-aos-duration="1000" data-aos-delay="50">
                    ...
                    <div className='flex flex-col gap-3 ' data-aos="zoom-out-up" data-aos-duration="1000" data-aos-delay="300">
                    ...
                    <div className='flex flex-col gap-3 ' data-aos="zoom-out-up" data-aos-duration="1000" data-aos-delay="500">
                    ...
                    <div className='flex flex-col gap-3 ' data-aos="zoom-out-up" data-aos-duration="1000" data-aos-delay="700">
                ...
                <div className='flex flex-col gap-3 py-8' data-aos="zoom-out-up" data-aos-duration="1000" data-aos-delay="700">
