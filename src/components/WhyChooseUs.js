    ...
    <>
      <div className='w-full flex items-end'>
        ...
        <div className="w-[56%] whychoose-bg py-20 px-10 flex flex-col gap-4">
           ...
           <h2 className='text-5xl font-black leading-tight text-white pb-5' data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">We are building a sustainable future</h2>

           <p className='text-white opacity-90 leading-relaxed pb-8' data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
           ...
           <div className='grid-cols-3 grid gap-6'>
              <div className='icon-box flex flex-col gap-4' data-aos="zoom-in" data-aos-duration="1000">
              ...
              <div className='icon-box flex flex-col gap-4' data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="300">
              ...
              <div className='icon-box flex flex-col gap-4' data-aos="zoom-in" data-aos-duration="1000" data-aos-delay="500">
