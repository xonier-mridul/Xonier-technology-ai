    ...
    <>
      <div className={`page-banner bg-${img} w-full py-40 pt-48 relative`}>
        ...
        <div className="relative z-10 max-w-7xl mx-auto flex flex-col items-start justify-center gap-6 ">
            ...
            <h1 className='text-6xl text-white font-bold capitalize' data-aos="fade-right" data-aos-duration="500">{title}</h1>
            <ul className=' px-5 py-2  flex items-center gap-4' data-aos="fade-right " data-aos-duration="500 " data-aos-delay="200">
